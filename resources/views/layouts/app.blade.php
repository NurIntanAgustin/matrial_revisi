...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="toast toast-basic position-fixed fade show" id="toast" role="status" aria-live="polite" aria-atomic="true" data-delay="1000" style="top: 1rem; right: 1rem;" data-autohide="true">
        ...
        <div class="toast-body">
            <div class="badge badge-pill badge-dark-{{ session('warna') }}">{{ session('status') }}
            </div>
        </div>
    </div>
    @endif
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="">
                        ...
                        <h3 class="brand-text">INTAN PERMATA</h3>
                    </a></li>
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy;
                {{ date('Y') }}<a class="ml-25">Pemrograman Internet Lanjut</a><span class="d-none d-sm-inline-block">, All
                    rights
                    Reserved</span></span><span class="float-md-right d-none d-md-block">Nur Intan Agustin<i data-feather="heart"></i></span></p>
    </footer>
