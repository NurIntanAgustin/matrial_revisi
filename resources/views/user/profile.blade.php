                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-12 media mb-2">
                                            <img src="{{ asset('/images/profile_user/' . $user->image) }}" alt="users avatar" class="user-avatar users-avatar-shadow rounded mr-2 my-25 cursor-pointer" height="90" width="90">
                                            <div class="media-body mt-50">
                                                <h4>{{ $user->name }}</h4>
                                                <div class="col-12 d-flex mt-1 px-0">
                                                    <label class="btn btn-primary mr-75 mb-0" for="change-picture">
                                                        <span class="d-none d-sm-block">Change</span>
                                                        <input class="form-control" type="file" id="change-picture" hidden="" accept="image/png, image/jpeg, image/jpg" name="file">
                                            ...
                                            <div class="row mt-2">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Username" value="{{ $user->name }}" name="name" id="username">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="name">Email</label>
                                                        <input type="email" class="form-control" placeholder="Name" value="{{ $user->email }}" name="email" id="name">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row ml-2 mt-1">
                                            <button class="btn btn-success btn-icon" onclick="return confirm('Profile anda akan dirubah?')"><i data-feather="save"></i>
                                                Save
                                                change</button>
                                        </div>
                                    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-10 col-lg-offset-3 mx-auto">
            <div class="pricing-trial-content d-flex justify-content-between">
                ...
                <!-- image -->
                <img src="{{ asset('/images/build.svg') }}" class="pricing-trial-img img-fluid" width="50%" alt="svg img">
            </div>
        </div>
    </div>
</div>
